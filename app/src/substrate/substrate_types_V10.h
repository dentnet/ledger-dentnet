...
typedef struct {
    const uint8_t* _ptr;
} pd_Ed25519Public_V10_t;

typedef struct {
    const uint8_t* _ptr;
} pd_Ed25519Signature_V10_t;

typedef struct {
    const uint8_t* _ptr;
} pd_Sr25519Public_V10_t;

typedef struct {
    const uint8_t* _ptr;
} pd_Sr25519Signature_V10_t;
...
typedef struct {
    pd_BalanceOf_t aye;
    pd_BalanceOf_t nay;
} pd_AccountVoteSplit_V10_t;

typedef struct {
    pd_Vote_V10_t vote;
    pd_BalanceOf_t balance;
} pd_AccountVoteStandard_V10_t;
...
typedef struct {
    uint8_t value;
    union {
        pd_Ed25519Signature_V10_t ed25519;
        pd_Sr25519Signature_V10_t sr25519;
        pd_EcdsaSignature_V10_t ecdsa;
    };
...
typedef struct {
    uint8_t value;
    union {
        pd_Ed25519Public_V10_t ed25519;
        pd_Sr25519Public_V10_t sr25519;
        pd_EcdsaPublic_V10_t ecdsa;
    };
...
typedef struct {
    uint8_t value;
    union {
        pd_AccountVoteStandard_V10_t voteStandard;
        pd_AccountVoteSplit_V10_t voteSplit;
    };
} pd_AccountVote_V10_t;
