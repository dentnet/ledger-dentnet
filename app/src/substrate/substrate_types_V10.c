...
{
    CHECK_ERROR(_readVote_V10(c, &v->vote));
...
parser_error_t _readAccountVote_V10(parser_context_t* c, pd_AccountVote_V10_t* v)
{
    ...
    switch (v->value) {
    case 0:
        CHECK_ERROR(_readAccountVoteStandard_V10(c, &v->voteStandard))
        break;
    case 1:
        CHECK_ERROR(_readAccountVoteSplit_V10(c, &v->voteSplit))
        break;
    default:
        break;
    }
...
parser_error_t _readMultiSignature_V10(parser_context_t* c, pd_MultiSignature_V10_t* v)
{
    ...
    switch (v->value) {
    case 0: // Ed25519
        CHECK_ERROR(_readEd25519Signature_V10(c, &v->ed25519))
        break;
    case 1: // Sr25519
        CHECK_ERROR(_readSr25519Signature_V10(c, &v->sr25519))
        break;
    case 2: // Ecdsa
        CHECK_ERROR(_readEcdsaSignature_V10(c, &v->ecdsa))
        break;
    default:
        return parser_unexpected_value;
    }
...
parser_error_t _readMultiSigner_V10(parser_context_t* c, pd_MultiSigner_V10_t* v)
{
    ...
    switch (v->value) {
    case 0: // Ed25519
        CHECK_ERROR(_readEd25519Public_V10(c, &v->ed25519))
        break;
    case 1: // Sr25519
        CHECK_ERROR(_readSr25519Public_V10(c, &v->sr25519))
        break;
    case 2: // Ecdsa
        CHECK_ERROR(_readEcdsaPublic_V10(c, &v->ecdsa))
        break;
    default:
        return parser_unexpected_value;
    }
...
parser_error_t _readRewardDestination_V10(parser_context_t* c, pd_RewardDestination_V10_t* v)
{
    ...
    if (v->value == 3) {
        CHECK_ERROR(_readAccountId_V10(c, &v->accountId))
    } else if (v->value > 4) {
        return parser_value_out_of_range;
    }
    return parser_ok;
    ...
    uint8_t* pageCount)
{
    ...
    pages[0] = 1;
    CHECK_ERROR(_toStringVote_V10(&v->vote, outValue, outValueLen, 0, &pages[1]))
    ...
    *pageCount = 0;
    ...
    if (pageIdx < pages[1]) {
        CHECK_ERROR(_toStringVote_V10(&v->vote, outValue, outValueLen, pageIdx, &pages[1]));
        return parser_ok;
    }
    pageIdx -= pages[1];
    ...
    uint8_t* pageCount)
{
    ...
    switch (v->value) {
    case 0:
        CHECK_ERROR(_toStringAccountVoteStandard_V10(&v->voteStandard, outValue, outValueLen, pageIdx, pageCount));
        break;
    case 1:
        CHECK_ERROR(_toStringAccountVoteSplit_V10(&v->voteSplit, outValue, outValueLen, pageIdx, pageCount));
        break;
    default:
        return parser_unexpected_value;
    }
    ...
    uint8_t* pageCount)
{
    ...
    switch (v->value) {
    case 0: // Ed25519
        CHECK_ERROR(_toStringEd25519Signature_V10(&v->ed25519, outValue, outValueLen, pageIdx, pageCount))
        break;
    case 1: // Sr25519
        CHECK_ERROR(_toStringSr25519Signature_V10(&v->sr25519, outValue, outValueLen, pageIdx, pageCount))
        break;
    case 2: // Ecdsa
        CHECK_ERROR(_toStringEcdsaSignature_V10(&v->ecdsa, outValue, outValueLen, pageIdx, pageCount))
        break;
    default:
        return parser_not_supported;
    }
    ...
    uint8_t* pageCount)
{
    ...
    switch (v->value) {
    case 0: // Ed25519
        CHECK_ERROR(_toStringEd25519Public_V10(&v->ed25519, outValue, outValueLen, pageIdx, pageCount))
        break;
    case 1: // Sr25519
        CHECK_ERROR(_toStringSr25519Public_V10(&v->sr25519, outValue, outValueLen, pageIdx, pageCount))
        break;
    case 2: // Ecdsa
        CHECK_ERROR(_toStringEcdsaPublic_V10(&v->ecdsa, outValue, outValueLen, pageIdx, pageCount))
        break;
    default:
        return parser_not_supported;
    }
    ...
    uint8_t* pageCount)
{
    ...
    *pageCount = 1;
    ...
    case 2:
        ...
        break;
    case 3:
        CHECK_ERROR(_toStringAccountId_V10(&v->accountId, outValue, outValueLen, pageIdx, pageCount));
        break;
    case 4:
        snprintf(outValue, outValueLen, "None");
        break;
