...
parser_error_t _readAccountVoteBalanceOf_V7(parser_context_t* c, pd_AccountVoteBalanceOf_V7_t* v);
...
parser_error_t _readBoxPalletsOrigin_V7(parser_context_t* c, pd_BoxPalletsOrigin_V7_t* v);
...
parser_error_t _readOpaqueCallT_V7(parser_context_t* c, pd_OpaqueCallT_V7_t* v);
...
parser_error_t _toStringAccountVoteBalanceOf_V7(
    const pd_AccountVoteBalanceOf_V7_t* v,
    char* outValue,
    uint16_t outValueLen,
    uint8_t pageIdx,
    uint8_t* pageCount);
...
parser_error_t _toStringBoxPalletsOrigin_V7(
    const pd_BoxPalletsOrigin_V7_t* v,
    char* outValue,
    uint16_t outValueLen,
    uint8_t pageIdx,
    uint8_t* pageCount);
...
parser_error_t _toStringOpaqueCallT_V7(
    const pd_OpaqueCallT_V7_t* v,
    char* outValue,
    uint16_t outValueLen,
    uint8_t pageIdx,
    uint8_t* pageCount);
